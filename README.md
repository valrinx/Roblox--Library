...
- ปรับ `Auto Mine` ให้อิงตารางราคา/`RequiredStrength` จาก `Ore list` ใน repo: ข้ามแร่ที่ดาเมจ pickaxe ต่ำกว่าเกณฑ์, เลือกเป้าที่แพงที่สุดในระยะก่อน (เทียบราคาขาย แล้วค่อยใกล้สุด), แสดงสถานะ `pickaxe too weak for nearby ores` เมื่อมีแร่ในระยะแต่ขุดไม่ได้ทั้งหมด
